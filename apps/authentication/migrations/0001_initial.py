...
import authentication.querysets.users
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', authentication.querysets.users.UsersManager()),
            ],
        ),
        migrations.CreateModel(
            name='Token',
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='created_authentication_tokens', to=settings.AUTH_USER_MODEL, verbose_name='Создано пользователем')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='created_authentication_confirmationcodes', to=settings.AUTH_USER_MODEL, verbose_name='Создано пользователем')),
